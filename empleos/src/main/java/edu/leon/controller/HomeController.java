...
public class HomeController {
    ...
    public String mostrarDetalle(Model model) {
        Vacante vacante = new Vacante(0, "Ingeniero de Comunicaciones", "Se solicita Ing. para dar soporte a intranet", LocalDate.now(), 9700.0,0);
...
//        model.addAttribute("fecha", LocalDateTime.now());
    ...
    private List<Vacante> getVacantes() {
        ...
        var vacante1 = new Vacante(1,"Ingeniero Civil","Se solicita Ing. Civil para " +
                "disenar puente peatonal",LocalDate.parse("08-02-2019",df),8500.0,1);
        vacantes.add(vacante1);

        vacante1 = new Vacante(2,"Contador Publico","Empresa importante solicita contandor con 5 anios de experiencia titulado",LocalDate.parse("09-02-2019",df),12000.0,0);
        vacantes.add(vacante1);
        ...
        vacante1 = new Vacante(4,"Disenador Grafico","Solicitamos Disenador Grafico titulado para disenar publicidad de la empresa",LocalDate.parse("01-02-2019",df),7500.0,1);
        vacantes.add(vacante1);
